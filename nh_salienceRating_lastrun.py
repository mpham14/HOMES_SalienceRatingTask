...
expName = 'nh_salienceRating'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/HOMES_SalienceRatingTask/nh_salienceRating_lastrun.py',
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='You will now look at the following objects and rate the object based on its salience. 1 being the least salience and 5 being the most salience.\n\nSalience is when something is being particularly noticeable and important, how prominent it is. \n\nPress SPACEBAR to continue',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
